...
|------------|------|---------|
| oci://artifacts.software-univention.de/nubus/charts | keycloak(keycloak) | 26.7.0 |
| oci://artifacts.software-univention.de/nubus/charts | nubusKeycloakBootstrap(keycloak-bootstrap) | 26.7.0 |
| oci://artifacts.software-univention.de/nubus/charts | nubusKeycloakExtensions(keycloak-extensions) | 0.24.9 |
...
| oci://artifacts.software-univention.de/nubus/charts | nubusPortalFrontend(portal-frontend) | 0.94.16 |
| oci://artifacts.software-univention.de/nubus/charts | nubusPortalServer(portal-server) | 0.94.16 |
| oci://artifacts.software-univention.de/nubus/charts | nubusProvisioning(provisioning) | 0.70.22 |
...
| oci://artifacts.software-univention.de/nubus/charts | nubusUdmListener(udm-listener) | 0.70.22 |
| oci://artifacts.software-univention.de/nubus/charts | nubusUdmRestApi(udm-rest-api) | 0.44.2 |
| oci://artifacts.software-univention.de/nubus/charts | nubusUmcGateway(umc-gateway) | 0.58.2 |
| oci://artifacts.software-univention.de/nubus/charts | nubusUmcServer(umc-server) | 0.58.2 |
